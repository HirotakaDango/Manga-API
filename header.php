      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 fw-medium">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'artists.php') echo 'active' ?>" href="/artists.php"><i class="bi bi-person-circle"></i> Artists</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == 'groups.php') echo 'active' ?>" href="/groups.php"><i class="bi bi-person-fill"></i> Groups</a>
            </li>
            <li class="nav-item">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu rounded-4 shadow border-0">
                  ...
                  <?php
                    ...
                    if (isset($loggedInUserId)) {
                      // If the user is logged in, show the profile and settings links
